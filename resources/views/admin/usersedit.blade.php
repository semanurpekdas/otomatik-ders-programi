    ...
    <div class="container-fluid" id="altbolum">
        <div class="row p-0" style="padding:0px !important">
            ...
            <div class="container-fluid card-container mt-5">
                <form method="POST" action="{{ route('admin.updateUser', $kullanici->guid) }}" enctype="multipart/form-data">
                    @csrf
                    @method('POST')
                    <div class="d-flex justify-content-center">
                        <div class="card col-6 m-4 primary-overlay">
                            ...
                            <div class="card-right p-3">
                                <h3 class="mb-4 text-center text-primary">Kullanıcı Bilgilerini Güncelle</h3>
                                @if ($errors->any())
                                ...
                                <div class="d-flex pe-3 mb-2">
                                    <div class="mb-4 me-3 d-flex ps-3 col-12 d-flex justify-content-center align-items-center pe-2">
                                        @if($kullanici->profilimg_path)
                                            <img src="{{ asset('storage/' . $kullanici->profilimg_path) }}" alt="Profil Fotoğrafı" class="rounded-circle border shadow p-0" width="200" height="200" id="profileimg">
                                        @endif
                                    </div>
                                </div>
                                <div class="d-flex pe-3 mb-2">
                                    <div class="mb-3 me-3 d-flex ps-3 col-6 d-flex align-items-center pe-2">
                                        ...
                                        <input type="text" class="form-control" name="isim" value="{{ $kullanici->isim }}" required>
                                    </div>
                                    <div class="mb-3 d-flex ps-3 col-6 d-flex align-items-center pe-2">
                                        <i class="bi bi-person me-1"></i>
                                        <input type="text" class="form-control" name="soyisim" value="{{ $kullanici->soyisim }}" required>
                                    </div>
                                </div> 
                                <div class="d-flex pe-3 mb-2">
                                    <div class="mb-3 me-3 d-flex ps-3 col-6 d-flex align-items-center pe-2">
                                        <i class="bi bi-envelope-at me-1"></i>
                                        <input type="email" class="form-control" name="email" value="{{ $kullanici->email }}" required>
                                    </div>
                                    <div class="mb-3 d-flex ps-3 col-6 d-flex align-items-center pe-2">
                                        <i class="bi bi-phone me-1"></i>
                                        <input type="tel" class="form-control" name="telefon" value="{{ $kullanici->telefon }}" required>
                                    </div>
                                </div>
                                <div class="d-flex pe-3 mb-2">
                                    <!-- Üniversite datalist -->
                                    <div class="mb-3 me-3 d-flex ps-3 col-6 d-flex align-items-center pe-2">
                                        ...
                                        <input type="text" class="form-control" name="universite_adi" list="universiteler" value="{{ optional($kullanici->universite)->isim }}" required>
                                    ...
                                    <div class="mb-3 d-flex ps-3 col-6 d-flex align-items-center pe-2">
                                        ...
                                        <input type="text" class="form-control" name="bolum" list="bolumler" id="bolumidupdate" value="{{ optional($kullanici->bolum)->bolum_isim }}">
                                ...
                                <div class="d-flex pe-3 mb-2">
                                    <div class="mb-3 me-3 d-flex ps-3 col-6 d-flex align-items-center pe-2">
                                        ...
                                        <select class="form-select" name="unvan" required>
                                            <option value="Öğrenci" {{ $kullanici->unvan == 'Öğrenci' ? 'selected' : '' }}>Öğrenci</option>
                                            <option value="Arş. Gör." {{ $kullanici->unvan == 'Arş. Gör.' ? 'selected' : '' }}>Arş. Gör.</option>
                                            <option value="Dr. Öğr." {{ $kullanici->unvan == 'Dr. Öğr.' ? 'selected' : '' }}>Dr. Öğr.</option>
                                            <option value="Doç. Dr." {{ $kullanici->unvan == 'Doç. Dr.' ? 'selected' : '' }}>Doç. Dr.</option>
                                            <option value="Prof. Dr." {{ $kullanici->unvan == 'Prof. Dr.' ? 'selected' : '' }}>Prof. Dr.</option>
                                        </select>
                                    </div>
                            ...
                            <div class="card-right p-3 ">
                                ...
                                @foreach($roles as $role)
                                    <div class="form-check d-flex align-items-center">
                                        ...
                                        @if($kullanici->roles->contains($role->id)) checked @endif>
                    ...
                    <div class="d-flex justify-content-center">
                        <button type="submit" class="btn btn-success text-white w-75 my-3">Güncelle</button>
                    </div>
                </form>
            </div>
        </div>
