...
<div class="col-2 sidebar">
    ...
    <li class="nav-item">
        ...
        <li class="nav-item">
            <a class="nav-link d-flex align-items-center {{ request()->routeIs('dersprogrami','dersprogramigoruntule') ? 'active light-active-overlay bg-dark' : '' }}" href="{{ route('dersprogrami') }}">
